    ...
    <div className="h-full bg-gemini-bg">
      <div className="h-full flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-1/2 border-b md:border-b-0 md:border-r border-gemini-border flex flex-col">
          ...
          {/* 图片上传区域 */}
          <div className="px-4 md:px-6 pt-4 md:pt-6 pb-4 border-b border-gemini-border">
            <div className="mb-3">
              ...
              {!selectedImage ? (
                <div
                  ...
                  className="border-2 border-dashed border-gemini-border rounded-2xl md:rounded-3xl p-4 md:p-6 
